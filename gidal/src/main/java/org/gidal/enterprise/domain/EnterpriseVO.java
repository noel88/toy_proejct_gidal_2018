...
//	private String enterprise_breakCloseTime; //브레이크타임끝
	...
	public String getEnterprise_mainImg() {
		return enterprise_mainImg;
	}


	public void setEnterprise_mainImg(String enterprise_mainImg) {
		this.enterprise_mainImg = enterprise_mainImg;
	}
